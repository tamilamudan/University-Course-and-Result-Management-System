...
public class course extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cdept =jTextField3.getText();
        ...
        try
        {
            ...
            st.executeUpdate("INSERT INTO course VALUES ('" + ccode+ "', '" + cname + "', '" + cdept + "')");
            ...
            JOptionPane.showMessageDialog(null, "Duplicate Course code! Please enter a Course code");
        }
